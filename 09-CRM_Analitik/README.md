...
- **9.1 CRM Giriş:**
    ...
    - **9.1.5 - Tekrar_İçin_Sorular.pdf:** 9.1 konusuna özel tekrar soruları ve cevap anahtarı.
- **9.2 RFM Analizi:**
    ...
    - **9.2.3 - Tekrar_İçin_Sorular.pdf:** 9.2 konusuna özel tekrar soruları ve cevap anahtarı.
- **9.3 Müşteri Yaşam Boyu Değeri (CLTV) ve Tahmini:**
    ...
    - **9.3.3 - Tekrar_İçin_Sorular.pdf:** 9.3 konusuna özel tekrar soruları ve cevap anahtarı.
- **9.4 Projeler:**
    ...
    - **9.4.4 - Tekrar_İçin_Sorular.pdf:** 9.4 konusuna özel tekrar soruları ve cevap anahtarı.
- **9.5 - Genel Tekrar Soruları:**
    - **9.5.1 - Genel_Tekrar_İçin_Sorular.pdf:** Modülün tamamını (9.1 - 9.4) kapsayan çoktan seçmeli test ve cevap anahtarı.
