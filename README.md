...
| 8    | `Pandas`                                            | Veri analizi ve manipülasyonu kütüphanesi. Series ve DataFrame yapıları, veri okuma/yazma, seçim, filtreleme, indeksleme, koşullu seçim, `iloc` & `loc`, eksik veri işlemleri, toplulaştırma ve gruplama, temel istatistiksel özetleme konularını içerir. |
