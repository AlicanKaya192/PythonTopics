...
# üzerinde yapılan diyabet araştırması için kullanılan verilziterdir. 768 gözlem ve 8 sayısal bağımsız değişkenden oluşmaktadır.
...
# # Yaş ve beden kitle indeksini bir arada düşünerek kategorik değişken oluşturuldu
...
# Son Model                          # eğer threshold 0.25-0.75 olursa;
# Accuracy: 0.78                     # Accuracy: 0.8
# Recall: 0.707                      # Recall: 0.736
# Precision: 0.65                    # Precision: 0.65
# F1: 0.68                           # F1: 0.69
# Auc: 0.76                          # AUC: 0.78
