...
# 3. YOL - Toplam değerle doldurmak
...
models = [('LR', LogisticRegression(random_state=12345)),
          ...
          ('XGB', XGBClassifier(random_state=12345, n_jobs=-1, verbose=-1)),
          ('Catboost', CatBoostClassifier(random_state=12345, thread_count=-1, verbose=False)),
          ('LGBM', LGBMClassifier(random_state=12345, n_jobs=-1, verbosity=0))]
...
models = [('LR', LogisticRegression(random_state=12345)),
          ('KNN', KNeighborsClassifier()),
          ('XGB', XGBClassifier(random_state=12345, n_jobs=-1, verbose=0)),
          ('Catboost', CatBoostClassifier(random_state=12345, thread_count=-1, verbose=False)),
          ('LGBM', LGBMClassifier(random_state=12345, n_jobs=-1, verbosity=0))]
...
################################################
# HİPERPARAMETRE OPTİMİZASYONU - KNN
################################################
